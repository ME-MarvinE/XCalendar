    ...
    public partial class NewDaysView : ContentView
    {
        ...
        public void UpdateDaysGrid()
        {
            ...
            else
            {
                ...
                while (DaysGrid.Children.Count < RequiredAmountOfChildren)
                {
                    View LastChild = DaysGrid.Children.Count == 0 ? null : DaysGrid.Children[DaysGrid.Children.Count - 1];
                    ...
                    DaysGrid.Children.Add(NewChild, NewChildColumnIndex, NewChildRowIndex);
                }
